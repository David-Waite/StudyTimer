<template>
  ...
  <form @submit.prevent="saveChanges">
    ...
    <input v-model="unisettings.pomodoroTime" type="number" id="pomodoroTime" step="0.01" />
...
const unisettings = usePomodoroSettingsStore().settings
</script>
