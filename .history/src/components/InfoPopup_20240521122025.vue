...
<template>
  <div v-if="open" class="popup">
    ...
    <div class="content">
      ...
      <div class="api">
        <p class="jokeInfo"></p>(Needed to use a api for the assignment criteria so here's a joke)</p>
        <p class="joke">Add a joke here</p>
      </div>
    </div>
  </div>
</template>
...
.joke {
  ...
  color: #ffff00;
  animation: JokeAnimation 1.5s linear infinite;
}
