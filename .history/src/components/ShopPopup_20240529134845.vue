...
export default {
  ...
  computed: {
    paginatedData() {
      ...
      console.log(this.studentMarks.slice(start, end))
      if (this.vehicles) {
        console.log(console.log(this.vehicles.slice(start, end)))
        console.log(this.vehicles)
        console.log(console.log(this.paginatedVehicles.slice(start, end)))  return this.studentMarks.slice(start, end)
      }
