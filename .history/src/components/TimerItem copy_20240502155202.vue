...
export default {
  data() {
    return {
      ...
      startingTime: useTimerStore().timerStore.pomodoroTime,
      strokeDashArray: 283,
      test: 23
    }
  },
  ...
  watch: {
    ...
    'timerStore.pomodoroTime': function (newStartTime, oldStartTime) {
      console.log(`Time has updated from ${newStartTime} to ${oldStartTime}`)
    }
  }
}
</script>
