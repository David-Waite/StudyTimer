...
import { BIconPauseBtnFill, BIconPlay, BIconStop } from 'bootstrap-icons-vue'
  ...
  <div>
    <div class="base-timer">
      <div class="buttonContiainer">
        ...
        <button v-if="timer.stage == 'running'" @click="timer.pauseTimer">
          <BIconPauseBtnFill />
        </button>
        <div class="pauseStopContainer">
          <button v-if="timer.stage == 'paused'" @click="timer.unpauseTimer"><BIconPause /></button>
