...
import Van from '../assets/vehicles/shop/vanStill.gif'
  ...
  <div v-if="$route.name === `shop`" class="shopContainer">
    ...
    <div class="vehicleGrid">
      <div class="vehicleContainer" v-for="(vehicle, index) in vehicles" v-bind:key="index">
        ...
        <video width="400" src="../assets/vehicles/shop/TheGhost.mov" controls autoplay>
          <source src="../assets/vehicles/shop/TheGhost.mov" type="video/qu" />
        </video>
