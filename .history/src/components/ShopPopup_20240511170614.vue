  ...
  <div v-if="$route.name === `shop`" class="shopContainer">
    ...
    <div class="vehicleGrid">
      <div class="vehicleContainer" v-for="(vehicle, index) in vehicles" v-bind:key="index">
        ...
        <button class="buyBtn" v-if="vehicle.status == 'buy'">Buy</button>
        <button class="equiped" v-if="vehicle.status == 'equiped'">Equipped</button>
        <button class="equip" v-if="vehicle.status == 'equip'">Equip</button>
      </div>
    </div>
  </div>
</template>
