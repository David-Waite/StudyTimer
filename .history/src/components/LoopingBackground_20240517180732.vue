...
import TheGhost from '../assets/vehicles/shop/TheGhostMoving.gif'
</script>
<template>
  <div class="outerContainer">
    ...
    <img
      ...
      alt=""
    /> -->
    <video class="vehicle" width="320" height="240" controls>
      <source src="../assets/vehicles/shop/TheGhost.mov" type="video/mp4" />
    </video>
  </div>
</template>
